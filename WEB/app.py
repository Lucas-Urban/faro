...
def encontrar_pet():
    ...
    encontrar_pet = EncontrarPet(nome=inputNomePet, local=inputLocalPet, tutor_nome=inputNomeTutor, tutor_email=inputEmailTutor, tutor_telefone=inputTelefoneTutor)
    ...
    classes = list(map(classificar_imagem, inputFotosPet))
